...
==========================================
Confronto tra Dijkstra vanilla e A* (= Dijkstra sul grafo sanato con i
...
riduzione % positiva significa che A* esplora meno nodi di Dijkstra
...
def confronta_nodi_esplorati(
    ...
    pipeline (predizioni -> BCF -> sanazione -> A*) e confronta i nodi
    ...
    for nome, source, target in coppie:
        try:
            ...
            riduzione_pct = (1 - n_astar / n_baseline) * 100 if n_baseline > 0 else 0

            print(
                f"{nome}: Dijkstra={n_baseline}, A*={n_astar}  "
                f"({riduzione_pct:+.1f}%)"
            )
            ...
            risultati.append(
                {
                    ...
                    "nodi_astar": n_astar, "riduzione_pct": riduzione_pct,
            ...
            risultati.append(
                {
                    ...
                    "nodi_baseline": n_baseline, "nodi_astar": n_astar,
