    ...
    for idx, target in enumerate(target_selezionati):
        ...
        for i in range(len(fasce_km)):
            ...
            for nodo in sorgenti:
                ...
                # weight_attr e' in decimi/centesimi/... di secondo secondo
                # la convenzione usata in src.grafo.carica_ambiente
                divisore = {
...
def _prepara_struttura_vicini(G: nx.MultiDiGraph, df_train: pd.DataFrame, weight_attr: str):
    """
...
def allena_modello_anelli(
    ...
    df_train, x_vicino = _prepara_struttura_vicini(G, df_train, weight_attr)
    print(
